...
const styleClasses = cva("", {
  variants: {
    variant: {
      ...
      h2: ["text-5xl", "md:text-6xl", "xl:text-8xl", "font-vibes"],
      h2Mobile: ["text-8xl", "md:text-10xl", "xl:text-12xl", "font-vibes"],
      ...
      h6: ["text-2xl", "md:text-3xl", "xl:text-4xl", "font-primary"],
      bodyLarge: ["text-xl", "md:text-2xl", "xl:text-4xl", "font-primary"],
      bodyLargeStrong: [
        "text-xl",
        "md:text-2xl",
        "xl:text-4xl",
      ...
      bodySmall: ["text-lg", "xl:text-lg", "font-primary"],
      bodySmallStrong: ["text-lg", "xl:text-2xl", "font-bold", "font-primary"],
